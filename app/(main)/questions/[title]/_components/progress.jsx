...
const Progress = ({ count, progress, attempts, previousAttempt, onPrevious, onNext, reset, totalQuestions }) => {
    ...
    return (
        <div className="max-w-[60%] mx-auto border border-gray-300 py-[20px] px-[20px] rounded-[5px] mt-[20px] bg-[white]">
