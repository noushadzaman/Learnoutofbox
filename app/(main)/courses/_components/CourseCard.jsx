...
const CourseCard = async ({ course, loggedInUser }) => {
  ...
  return (
    <div
      className="shadow-[#e1ecfe] shadow-lg rounded-[5px] max-w-[350px] flex flex-col items-center">
      ...
      <div className="flex flex-col justify-between h-[100%] gap-[15px] p-[30px]">
        <div className="">
          ...
          <Link
            ...
            key={course.id} href={`/courses/${course.id}`}
          >
            <p className="text-[24px] font-[800] leading-[31px] text-[#00030e] group-hover:text-[#fe4a55] ease-in duration-150">{title}</p>
            <p className="text-[17px] font-[500] leading-[31px] text-[#00030e] mb-2">{course?.category?.title}</p>
          </Link>
